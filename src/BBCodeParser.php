...
class BBCodeParser
{
    ...
    public function __construct()
    {
        $this->parsers = [
            'bold' => [
                'pattern' => '/\[b\](.*?)\[\/b\]/s',
                'replace' => '<strong ' . @config('bbcodeparser.attributes')['bold'] . '>$1</strong>',
                'content' => '$1',
            ],
            'italic' => [
                'pattern' => '/\[i\](.*?)\[\/i\]/s',
                'replace' => '<em ' . @config('bbcodeparser.attributes')['italic'] . '>$1</em>',
                'content' => '$1',
            ],
            'underline' => [
                'pattern' => '/\[u\](.*?)\[\/u\]/s',
                'replace' => '<u ' . @config('bbcodeparser.attributes')['underline'] . '>$1</u>',
                'content' => '$1',
            ],
            'linethrough' => [
                'pattern' => '/\[s\](.*?)\[\/s\]/s',
                'replace' => '<strike ' . @config('bbcodeparser.attributes')['linethrough'] . '>$1</strike>',
                'content' => '$1',
            ],
            'size' => [
                'pattern' => '/\[size\=([1-7])\](.*?)\[\/size\]/s',
                'replace' => '<font ' . @config('bbcodeparser.attributes')['size'] . ' size="$1">$2</font>',
                'content' => '$2',
            ],
            'color' => [
                'pattern' => '/\[color\=(#[A-f0-9]{6}|#[A-f0-9]{3})\](.*?)\[\/color\]/s',
                'replace' => '<font ' . @config('bbcodeparser.attributes')['color'] . ' color="$1">$2</font>',
                'content' => '$2',
            ],
            'center' => [
                'pattern' => '/\[center\](.*?)\[\/center\]/s',
                'replace' => '<div ' . @config('bbcodeparser.attributes')['center'] . ' style="text-align:center;">$1</div>',
                'content' => '$1',
            ],
            'left' => [
                'pattern' => '/\[left\](.*?)\[\/left\]/s',
                'replace' => '<div ' . @config('bbcodeparser.attributes')['left'] . ' style="text-align:left;">$1</div>',
                'content' => '$1',
            ],
            'right' => [
                'pattern' => '/\[right\](.*?)\[\/right\]/s',
                'replace' => '<div ' . @config('bbcodeparser.attributes')['right'] . ' style="text-align:right;">$1</div>',
                'content' => '$1',
            ],
            'quote' => [
                'pattern' => '/\[quote\](.*?)\[\/quote\]/s',
                'replace' => '<blockquote ' . @config('bbcodeparser.attributes')['quote'] . '>$1</blockquote>',
                'content' => '$1',
            ],
            'namedquote' => [
                'pattern' => '/\[quote\=(.*?)\](.*)\[\/quote\]/s',
                'replace' => '<blockquote ' . @config('bbcodeparser.attributes')['namedquote'] . '><small>$1</small>$2</blockquote>',
                'content' => '$2',
            ],
            'link' => [
                'pattern' => '/\[url\](.*?)\[\/url\]/s',
                'replace' => '<a ' . @config('bbcodeparser.attributes')['link'] . ' href="$1">$1</a>',
                'content' => '$1',
            ],
            'namedlink' => [
                'pattern' => '/\[url\=(.*?)\](.*?)\[\/url\]/s',
                'replace' => '<a ' . @config('bbcodeparser.attributes')['namedlink'] . ' href="$1">$2</a>',
                'content' => '$2',
            ],
            'image' => [
                'pattern' => '/\[img\](.*?)\[\/img\]/s',
                'replace' => '<img ' . @config('bbcodeparser.attributes')['image'] . ' src="$1">',
                'content' => '$1',
            ],
            'orderedlistnumerical' => [
                'pattern' => '/\[list=1\](.*?)\[\/list\]/s',
                'replace' => '<ol ' . @config('bbcodeparser.attributes')['orderedlistnumerical'] . '>$1</ol>',
                'content' => '$1',
            ],
            'orderedlistalpha' => [
                'pattern' => '/\[list=a\](.*?)\[\/list\]/s',
                'replace' => '<ol ' . @config('bbcodeparser.attributes')['orderedlistalpha'] . ' type="a">$1</ol>',
                'content' => '$1',
            ],
            'unorderedlist' => [
                'pattern' => '/\[list\](.*?)\[\/list\]/s',
                'replace' => '<ul ' . @config('bbcodeparser.attributes')['unorderedlist'] . '>$1</ul>',
                'content' => '$1',
            ],
            'listitem' => [
                'pattern' => '/\[\*\](.*)/',
                'replace' => '<li ' . @config('bbcodeparser.attributes')['listitem'] . '>$1</li>',
                'content' => '$1',
            ],
            'code' => [
                'pattern' => '/\[code\](.*?)\[\/code\]/s',
            ...
            'youtube' => [
                ...
                'replace' => '<iframe ' . @config('bbcodeparser.attributes')['youtube'] . ' width="560" height="315" src="//www.youtube.com/embed/$1" frameborder="0" allowfullscreen></iframe>',
                'content' => '$1',
            ],
            'linebreak' => [
                'pattern' => '/\r\n/',
                'replace' => '<br ' . @config('bbcodeparser.attributes')['linebreak'] . ' />',
                'content' => '',
            ],
            'sub' => [
                'pattern' => '/\[sub\](.*?)\[\/sub\]/s',
